...
async def get_thumb(videoid):
    ...
    try:
        ...
        try:
            font_title = ImageFont.truetype("Tune/assets/thumb/font.ttf", 45)
            font_details = ImageFont.truetype("Tune/assets/thumb/font2.ttf", 30)
            font_watermark = ImageFont.truetype("Tune/assets/thumb/font2.ttf", 25)
        except:
